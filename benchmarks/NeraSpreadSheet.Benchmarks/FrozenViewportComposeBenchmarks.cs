...
[MemoryDiagnoser]
public class FrozenViewportComposeBenchmarks
{
    ...
    public int Compose120FrozenFramesWithoutCache() =>
        Compose120Frames(_uncached, clearCacheFirst: false);

    [Benchmark]
    public int Compose120FrozenFramesWithPaneCache() =>
        Compose120Frames(_cached, clearCacheFirst: true);
