...
public sealed class StyleRenderingTests
{
    ...
    public void ComposeUsesInternedFillFontAndBorderStyle()
    {
        ...
        {
            Font = CellStyle.Default.Font with { Weight = 700, Color = new ColorRgba(12, 34, 56) },
        ...
        Assert.IsTrue(displayList.Commands.OfType<DrawTextCommand>().Any(command => command.Text == "Styled" && command.Style.FontWeight == 700 && command.Style.Color == style.Font.Color));
