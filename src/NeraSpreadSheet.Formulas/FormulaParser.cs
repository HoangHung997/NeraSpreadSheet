...
internal sealed class FormulaParser
{
    ...
    private FormulaNode ParseComparison()
    {
        ...
        while (_current.Kind is FormulaTokenKind.Equal or FormulaTokenKind.NotEqual or FormulaTokenKind.Less or FormulaTokenKind.LessOrEqual or FormulaTokenKind.Greater or FormulaTokenKind.GreaterOrEqual)
        {
    ...
    private FormulaNode ParsePrimary()
    {
        ...
        MoveNext();
        if (_current.Kind != FormulaTokenKind.Identifier || !CellAddress.TryParseA1(_current.Text, out var secondAddress))
        {
    ...
    private FormulaNode ParseFunction(string name)
    {
        MoveNext();
