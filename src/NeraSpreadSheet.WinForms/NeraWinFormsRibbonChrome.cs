    ...
    Color Hover, Color Pressed, Color Checked, Color Accent)
{
    internal static NeraWinFormsRibbonPalette For(NeraIconTheme theme) => theme switch
    {
        ...
        NeraIconTheme.HighContrastDark => new(Color.FromArgb(37, 37, 37), Color.FromArgb(32, 32, 32), Color.FromArgb(244, 244, 244), Color.White, Color.White, Color.FromArgb(58, 58, 58), Color.FromArgb(73, 96, 82), Color.FromArgb(58, 58, 58), Color.FromArgb(255, 239, 0)),
        NeraIconTheme.HighContrastLight => new(Color.White, Color.FromArgb(245, 247, 246), Color.FromArgb(36, 41, 45), Color.Black, Color.Black, Color.FromArgb(217, 229, 255), Color.FromArgb(200, 226, 210), Color.FromArgb(217, 229, 255), Color.FromArgb(0, 53, 178)),
