...
| Formula surface | 144 eager/versioned + 18 special + 5 dynamic built-ins = 167 names | advanced statistics, remaining finance, advanced lookup/arrays and special engineering |
...
| Statistics | Median/mode, inclusive percentile/quartile, variance/deviation, rank and order statistics | covariance, correlation, regression and distributions |
...
| Data / analysis | Basic sort, validation, Tables, filters, totals, dynamic FILTER/SORT/UNIQUE and database aggregates | advanced sort, grouping, virtual data, pivot and slicers |
