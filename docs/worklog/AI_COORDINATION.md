...
write_lock:
  state: HELD
  owner: CODEX
  lease_id: CODEX-RIBBON-001-CI-20260828T054625Z
  acquired_utc: 2026-08-28T05:46:25Z
  expires_utc: 2026-08-28T05:56:25Z
  purpose: Mark RIBBON-001 CI_RUNNING with exact-head run.

last_update:
  utc: 2026-08-28T05:45:33Z
  writer: CODEX
  summary: RIBBON-001 local verification green at d2d009c; branch pushed; starting exact-head CI.
```
...
| `RIBBON-001` | `LOCAL_GREEN` | Codex | `ai/codex/ribbon-bars-customization` | `src/NeraSpreadSheet.Ribbon.Core/**`, `src/NeraSpreadSheet.Bars.Core/**`, test riêng của hai module, contract riêng | Base `fea278057465a983d85c0b472532a2d13c644c37`; không giao Q003B-MAC | Build/test module, architecture verification và branch CI xanh. |
