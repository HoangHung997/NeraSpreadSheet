...
write_lock:
  state: HELD
  owner: CODEX
  lease_id: CODEX-RIBBON-002-START-20260828T063037Z
  acquired_utc: 2026-08-28T06:30:37Z
  expires_utc: 2026-08-28T06:40:37Z
  purpose: Start RIBBON-002 implementation after required reading.

last_update:
  utc: 2026-08-28T06:27:49Z
  writer: CODEX
  summary: Claimed stacked RIBBON-002 at RIBBON-001 commit d2d009c after explicit OWNER instruction to continue.
```
...
| `RIBBON-002` | `CLAIMED` | Codex | `ai/codex/ribbon-bars-persistence` | `src/NeraSpreadSheet.Ribbon.Core/**`, `src/NeraSpreadSheet.Bars.Core/**`, persistence tests của hai module, `docs/ribbon-bars-persistence-contract.md` | Stacked trên `RIBBON-001` commit `d2d009cc909a3f16b242a282444ae8011727fa31`; OWNER cho phép tiếp tục trước tích hợp | Versioned persistence, deterministic round-trip, invalid/future schema rejection; không sửa MAUI/workflow/tài liệu dùng chung. |
